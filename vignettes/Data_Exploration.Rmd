...
# Relationships
A starting step in your analysis might be to explore the univariate relationships between occurrence and single environmental parameters. This initial exploration is useful to identify any obvious patterns in the data, and can also be helpful to identify outliers in the covariates. 

*is this relevant for binary data?*
