...
`str()` will show us the structure of our data, allowing us to confirm the form our data are stored in. This function will allow us to check the data type that each variable is stored as, for example factors for categorical data and numeric for continuous data. 
...
We can check the spread of our occurrence and covariate data, for example, with the `Outliers` module. 
