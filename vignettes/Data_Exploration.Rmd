...
**CovHistograms module works on the raster data not the point data. Need to re-work the Data Exploration guide. Alternatively get it to plot on both point and raster data.**

**Explain NAs in figure**
