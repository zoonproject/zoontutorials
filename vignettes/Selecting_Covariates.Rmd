...
vignette: >
  ...
  %\VignetteIndexEntry{Selecting Covariates}
...
```{r echo = F, out.width= '400px', fig.align = "center", fig.cap="*Figure 1. Conceptual flowchart for data exploration steps.*"}
