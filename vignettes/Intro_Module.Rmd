...
But first, let's fit a quick and simple SDM with `zoon` as a means of introdction. Don't forget to load the package!
...
In this workflow, we have loaded the Carolina Wren presence-only occurrence data for the Usa, loaded the environmental covariates, selected 100 background occurrence data (more on this later), fitted a logistic regression model, and printed a map. The map shows us how the probability of occurrence of the Carolina Wren varies across the USA. The red dots show recorded presences. Most of the map has a low probility of occurance (light green) but there is a patch of high occurrence probabilty (blue) in the centre. The model has estimated the area of detected presences as havign a high liklihood of occurrence.
