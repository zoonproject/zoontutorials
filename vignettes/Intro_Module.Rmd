...
library(zoon)
```
An basic workflow, in this example for the mosquito *Anopheles Plumbeus* in the UK, might look like this:  
...
`zoon` comes with several pre-existing modules for each argument, which we will go through in more detail in the rest of this guide. You might like to explore some different combinations yourself, and you can find more information by running the `GetModuleList` command.
