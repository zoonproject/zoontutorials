...
Often we want to see how the probability of occurrence in environemntal space is projected into real geographic space. We do this by asking our workflow to output a map. 

Interogating estiamted model coefficients can help us make ecological inferences. Model coefficientsNot all types of species distribtion models produce coefficient estimates.
...
#Make a .
ChangeWorkflow(Carolina_Wren_Workflow, output = SurfaceMap)

#Interactive map of probabilities and occurrence data, and background points
ChangeWorkflow(Carolina_Wren_Workflow, output = InteractiveMap)

#Plot response curve
ChangeWorkflow(Carolina_Wren_Workflow, output = ResponseCurve())

<<<<<<< HEAD
#Plot response curve Viz
ChangeWorkflow(Carolina_Wren_Workflow, output = ResponseCurveViz(1:4))

#Predict to new place or time
ChangeWorkflow(Carolina_Wren_Workflow, output = PredictNewRasterMap(rasterB))

#Plot performance measures
ChangeWorkflow(Carolina_Wren_Workflow,
               process = BackgroundAndCrossvalid,
               output = PerformanceMeasures)

#Get coefficient estimates
ChangeWorkflow(Carolina_Wren_Workflow, output = VariableImportance)

#density box plot of presence versus absense. No key
ChangeWorkflow(Carolina_Wren_Workflow, output = SeparatePA)
...
>>>>>>> 04d6ae8a86f59f24c7be58eb62d57639099158e3
