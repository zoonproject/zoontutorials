...
```{r echo = F, out.width= '400px', fig.align = "center", fig.cap="*Figure 2. Species Distribution Modelling for mapping: predicted distribution of zoonotic Ebola virus (from @pigott14) .*"}
...
```{r echo = F, out.width= '650px', fig.align = "center", fig.cap="*Figure 3. Species Distribution Modelling for future prediction: cane toad current and projected future extent (maps courtesy of @elith10; photo from @fraser-smith) .*"}
