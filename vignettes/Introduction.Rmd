...
zoon_workflow <- workflow(occurrence = SugarMaple,
                             covariate = Bioclim(extent = c(-170, -20, 10, 80)),
                             process = Background(100),
                             model = RandomForest,
                             output = PrintMap)
```

In this workflow, we have loaded the Sugar Maple presence-only occurrence data for the USA, loaded the Bioclim environmental covariates, selected 100 background occurrence data (more on this later), fit a Random Forest model, and printed a map. The map shows us how the probability of occurrence of Sugar Maple varies across the USA. Throughout this tutorial we will guide you step-by-step through each of the arguments in a workflow as we update this `zoon_workflow`.
