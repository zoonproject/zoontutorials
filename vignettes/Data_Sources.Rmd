...
Now that we've seen the different ways of obtaining data in `zoon`, lets see an example. Here we obtain presence-only data for the Caroina Wren in the USA from GBIF, and bioclimatic variables from Wordclim.

```{r eval=TRUE, message=FALSE, warning=FALSE}
CW_Online_Data <- workflow(occurrence = SpOcc(species = "Thryothorus ludovicianus",
