...
Now that we've seen the different ways of obtaining data in `zoon`, lets see an example. Here we obtain presence-only data for the Grizzly Bear, *Ursus arctod* in North America from GBIF, and bioclimatic variables from Wordclim.
